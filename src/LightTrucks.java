// 小型トラックの情報
public class LightTrucks extends CarAttribute {

    private static final int MAX_LOAD_CAPACITY = 5000;

    private static final int MIN_LOAD_CAPACITY = 1000
            ;
    private static final int MAX_VOLUME_CAPACITY = 5;

    public LightTrucks(int carnumber, String carname, String driver, int stock, int volume) {
